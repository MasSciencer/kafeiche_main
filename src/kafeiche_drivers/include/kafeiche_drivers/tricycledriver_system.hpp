#ifndef TRICYCLEDRIVER_SYSTEM_HPP
#define TRICYCLEDRIVER_SYSTEM_HPP
...
#include "tricycledriver_system_wheel.hpp"
...
{
class TricycleKfc : public hardware_interface::SystemInterface
{
...
struct Config
{
    ...
    public:
        RCLCPP_SHARED_PTR_DEFINITIONS(TricycleKfc)
