#ifndef TRICYCLEDRIVER_SYSTEM_SUB_HPP
#define TRICYCLEDRIVER_SYSTEM_SUB_HPP
...
class TricycleSubscriber : public rclcpp::Node {
public:
  TricycleSubscriber() : Node("diff_sub") {
    ...
    left_wheel_velocity_subscriber_ = this->create_subscription<std_msgs::msg::Float64>(
      ...
      std::bind(&TricycleSubscriber::left_wheel_velocity_callback, this, std::placeholders::_1));

    left_wheel_position_subscriber_ = this->create_subscription<std_msgs::msg::Float64>(
      "/kfc/left_wheel/position", rclcpp::QoS(RATE),
      std::bind(&TricycleSubscriber::left_wheel_position_callback, this, std::placeholders::_1));
    ...
    right_wheel_velocity_subscriber_ = this->create_subscription<std_msgs::msg::Float64>(
      ...
      std::bind(&TricycleSubscriber::right_wheel_velocity_callback, this, std::placeholders::_1));

    right_wheel_position_subscriber_ = this->create_subscription<std_msgs::msg::Float64>(
      "/kfc/right_wheel/position", rclcpp::QoS(RATE),
      std::bind(&TricycleSubscriber::right_wheel_position_callback, this, std::placeholders::_1));
  }
