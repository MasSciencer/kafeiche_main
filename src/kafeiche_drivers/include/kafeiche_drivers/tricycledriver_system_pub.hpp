#ifndef TRICYCLEDRIVER_SYSTEM_PUB_HPP
#define TRICYCLEDRIVER_SYSTEM_PUB_HPP
...
class TricyclePublisher : public rclcpp::Node {
public:
  TricyclePublisher() : Node("tricycle_pub"), left_vel_(0.0), right_vel_(0.0) {
    ...
    timer_ = this->create_wall_timer(
       std::chrono::milliseconds(100), std::bind(&TricyclePublisher::timer_callback, this));
  }
